...
import { folderSelectOptions } from "../lib/drive-folders-ui";
...
export function DriveEditSheet({
  ...
  useEffect(() => {
    ...
    setFolderId(object.folderId ?? "");

    setError(null);

  }, [object]);

  const folderSelectOptionsList = folderSelectOptions(folders);
        ...
        <form className="space-y-3" onSubmit={save}>
          ...
          <label className="block space-y-1">
            ...
            <Select
              ...
              disabled={loading}
            >
              {folderSelectOptionsList.map((opt) => (
