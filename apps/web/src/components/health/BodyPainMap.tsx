...
const FRONT_REGIONS: RegionShape[] = [
  ...
  { region: "chest", shape: "rect", x: 70, y: 50, w: 60, h: 40, rx: 10 },
...
const BACK_REGIONS: RegionShape[] = [
  ...
  { region: "left_shoulder_blade", shape: "rect", x: 68, y: 50, w: 26, h: 30, rx: 8 },
  { region: "right_shoulder_blade", shape: "rect", x: 106, y: 50, w: 26, h: 30, rx: 8 },
